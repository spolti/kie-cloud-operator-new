...
// the KieApp object against the actual cluster state, and then
...
func (reconciler *KieAppReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	log.Info("Reconciling for KieApp")
	...
	if opName, depNameSpace, useEmbedded := defaults.UseEmbeddedFiles(reconciler.Service); !useEmbedded {
		...
		err := reconciler.Get(ctx, types.NamespacedName{Namespace: depNameSpace, Name: opName}, myDep)
		if err == nil {
			if shouldDeployConsole() {
				deployConsole(ctx, reconciler, myDep)
			}
			reconciler.CreateConfigMaps(myDep)
		} else {
			log.Error(err, "Can't properly create ConfigMaps.")
		}
		if err = reconciler.createConsoleYAMLSamples(); err != nil {
			log.Error(err, "Error occurs while creating Console YAML samples")
		}
	}
	...
	if err != nil {
		if errors.IsNotFound(err) {
			...
			log.Info("No Custom Resource found named %s. Checking for dependent objects to delete.", request.Name)
	...
	if len(delta.Added) > 0 {
		log.Debug("Will create %d routes that were not found", len(delta.Added))
...
func (reconciler *KieAppReconciler) checkStatus(ctx context.Context, instance, cachedInstance *api.KieApp, hasUpdates bool) (reconcile.Result, error) {
	var requeue bool
	if hasUpdates {
...
func (reconciler *KieAppReconciler) updateStatus(ctx context.Context, instance, cachedInstance *api.KieApp, requeue bool) (reconcile.Result, error) {
...
func (reconciler *KieAppReconciler) reconcileResources(ownerController metav1.Object, requestedResources []client.Object, deployed map[reflect.Type][]client.Object) (bool, error) {
...
func (reconciler *KieAppReconciler) verifyExternalReferences(cr *api.KieApp) error {
	var err error
...
func (reconciler *KieAppReconciler) verifyExternalReference(namespace string, ref *api.ObjRef) error {
	if ref == nil {
		return nil
	}
...
func (reconciler *KieAppReconciler) hasStatusChanges(instance, cachedInstance *api.KieApp) bool {
...
func (reconciler *KieAppReconciler) setFailedStatus(instance *api.KieApp, reason api.ReasonType, err error) {
...
func (reconciler *KieAppReconciler) createLocalImageTag(tagRefName, imageURL string, cr *api.KieApp) error {
...
func (reconciler *KieAppReconciler) loadRoutes(requestedRoutes []client.Object) (map[types.NamespacedName]routev1.Route, error) {
...
func (reconciler *KieAppReconciler) setEnvironmentProperties(cr *api.KieApp, env api.Environment, routes []client.Object, caConfigMap *corev1.ConfigMap) (api.Environment, error) {
...
func (reconciler *KieAppReconciler) setConsoleHost(cr *api.KieApp, env api.Environment, routes []client.Object) (consoleCN string) {
...
func (reconciler *KieAppReconciler) getKubernetesResources(cr *api.KieApp, env api.Environment) []client.Object {
...
func (reconciler *KieAppReconciler) imageStreams(cr *api.KieApp, objects []api.CustomObject) []api.CustomObject {
...
func (reconciler *KieAppReconciler) generateKeystoreSecret(secretName, keystoreCN string, cr *api.KieApp) (secret corev1.Secret, err error) {
...
func (reconciler *KieAppReconciler) generateTruststoreSecret(secretName string, cr *api.KieApp, caConfigMap *corev1.ConfigMap) (secret corev1.Secret, err error) {
...
func (reconciler *KieAppReconciler) getCustomObjectResources(object api.CustomObject, cr *api.KieApp) []client.Object {
...
func (reconciler *KieAppReconciler) ensureImageStream(name, namespace, imageURL string, cr *api.KieApp) (string, error) {
	if cr.Status.Applied.ImageRegistry != nil {
...
func (reconciler *KieAppReconciler) createObj(object client.Object, err error) (reconcile.Result, error) {
...
func (reconciler *KieAppReconciler) createConfigMap(obj api.OpenShiftObject) (*corev1.ConfigMap, bool) {
...
func (reconciler *KieAppReconciler) checkKieServerConfigMap(instance *api.KieApp, env api.Environment) {
...
func (reconciler *KieAppReconciler) getDeployedResources(instance *api.KieApp) (map[reflect.Type][]client.Object, error) {
...
func (reconciler *KieAppReconciler) getCSV(operator *appsv1.Deployment) *operatorsv1alpha1.ClusterServiceVersion {
...
func (reconciler *KieAppReconciler) getConsoleLinkResource(cr *api.KieApp) client.Object {
